namespace DnsClient.Tests
{
    ...
    public class DnsRecordFactoryTest
    {
        ...
        public void DnsRecordFactory_NSRecordNotEnoughData()
        {
            var data = new byte[0];
            var factory = GetFactory(data, out var reader);
            var info = new ResourceRecord(DnsString.Parse("query.example.com"), NsRecord.ResourceRecordType, QueryClass.In, 0, data.Length);
        ...
        public void DnsRecordFactory_SOARecordEmpty()
        {
            var data = new byte[0];
            var factory = GetFactory(data, out var reader);
            var info = new ResourceRecord(DnsString.Parse("query.example.com"), SoaRecord.ResourceRecordType, QueryClass.In, 0, data.Length);
        ...
        public void DnsRecordFactory_TXTRecordEmpty()
        {
            ...
            var info = new ResourceRecord(DnsString.Parse("query.example.com"), TxtRecord.ResourceRecordType, QueryClass.In, 0, data.Count);
        ...
        public void DnsRecordFactory_SSHFPRecord()
        {
            ...
            var factory = GetFactory(data.ToArray(), out var reader);
            var info = new ResourceRecord(DnsString.Parse("query.example.com"), SshfpRecord.ResourceRecordType, QueryClass.In, 0, data.Count);
